...
class Parser(object):
    def getParser(self):
        ...
        parser.add_argument('--dim', type=int, default=200, help="Dimension of hidden layer")
        parser.add_argument('--statedim', type=int, default=200, help="Dimension of state")
        parser.add_argument('--batchsize', type=int, default=256, help="Batch size on training")
